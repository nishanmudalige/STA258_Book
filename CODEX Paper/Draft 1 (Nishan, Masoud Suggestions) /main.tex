...
At the end of each major topic in Chapters 3 -- 10 of the e-book, we also included example questions with solutions. 
...
Examples from Chapters 3 -- 10 covered numerical calculations, interpretations, explanations and many also included a coding component involving R.
The examples can be studied by students to reinforce the concepts covered in the book and they also provide opportunities to practice coding in R.

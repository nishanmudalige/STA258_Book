...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Landing page of the e-book in the default light theme and dark theme. Notice the table of contents on the left. Icons for changing theme, searching, changing font size and spacing are located near the top left.}
...
An example of the appearance of text-based content of the body of the e-book is presented in Figure \ref{fig:sample_content}.
...
This chapter also provides information on working with R Studio which is a popular integrated development environmentSome examples of (IDE) for programming in R.

...
%────────────────────────────────────────────────
\title{Student-Faculty Co-Creation of Open Source Resources for Learning Applied Statistics}
\author{%
    \begin{tabular}{c}
...
A brief description of the specific R packages from Table $\ref{tab:ebook_Technologies}$ are given in Table $\ref{tab:R_Packages}$:
\renewcommand\arraystretch{1.25}
\begin{table}[H]
\setlength{\belowcaptionskip}{-25pt}
\begin{center}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Sample content from the Chapter on descriptive statistics.}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=0.80\textwidth]{Images/example_screen_sec_4_crop.png}
        \caption{Sample content from the Chapter on foundations on inference}
    \end{subfigure}
    \caption{Landing page of the e-book in the default and dark theme. Notice the table of contents on the left.}
...
Many of the static figures were created using \texttt{ggplot2}.
...
Not all of the figures in the e-book required an interactive component, since they may have become unnecessarily distractive for students.
Examples of figures which had their interactive options removed are presented in Figures

Examples were presented with R code for students.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=0.975\textwidth]{Images/interactive_hist_1.png}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=0.975\textwidth]{Images/interactive_hist_4.png}
        \caption{Interactive histogram with the slider for bin width set to a bin width of 4 minutes.}
    \end{subfigure}
    \caption{Interactive application that allows students to adjust the bin width for a histogram built on real-world data (geyser eruption waiting times). The tool demonstrates how histogram appearance is sensitive to graphical parameters, enhancing students’ understanding of distribution shape and granularity.}
    \label{fig:interactive_hist}
\end{figure}

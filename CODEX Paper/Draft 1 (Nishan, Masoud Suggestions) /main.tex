...
The final component in the e-book we would like to discuss are the examples.
At the end of each major topic in Sections 3 -- 10 of the e-book, we included example questions with solutions. 
Recall that Section 1 introduces the e-book and Section 2 is a section introducing R.
Therefore, we did not consider the need to include examples for these 2 sections.

Examples from Sections 3 -- 10 covered numerical calculations, interpretations, explanations and many also included a coding component involving R.
Examples can be studied by students to reinforce the concepts covered in the book and they also provide opportunities to practice coding in R.

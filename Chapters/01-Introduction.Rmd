...
```{r fig.cap="Illustration of parameters in a population and statistics in a sample", echo=FALSE, fig.align='center', warning=FALSE}
library(plotly)
...
p <- plot_ly() %>%
  ...
  layout(
    ...
    annotations = list(
      # straight arrow
      list(
        x   =  0.00, y   = samp_ctr_y + 0.95,
        ax  =  0.00, ay  = pop_ctr_y - 1.25,
        xref= 'x',     yref= 'y',
        axref= 'x',    ayref= 'y',
        showarrow = TRUE,
        arrowhead = 2,

...
```{r ch3-coffee-dot, echo=FALSE, fig.height=2.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
...
**(d)** Replacing 7 with 12: new $\bar{x} = 24/11 \approx 2.18$ (increased by ~0.45); median remains **1**. The **mean is sensitive to outliers**; the median is **robust** because it depends only on the middle value's position.
</div>
</details>

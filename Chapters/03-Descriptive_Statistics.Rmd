...
ggplot(df, aes(x = x)) +
  ...
  # median & mean lines
  geom_vline(xintercept = med_val,  color = median_col, size = 1) +
  geom_vline(xintercept = mean_val, color = mean_col,   size = 1, linetype = "dashed") +
  # annotations
  annotate("text",
           x      = 0.8, y      = y_tail,
           label  = "Right Tail",
  ...
  annotate("text",
           ...
           label  = "median",
           fontface= "bold", hjust = 1.1, color = median_col) +
  annotate("text",
           x      = mean_val + 0.025, y = y_mean,
           label  = "mean",
           fontface= "bold", hjust = -0.1, color = mean_col) +
  # exact axis limits, no extra padding
...
```{r SymmetryExample, fig.cap="An illustration of an approcimately symmetric distribution.", echo=FALSE, fig.align='center', warning=FALSE}
library(ggplot2)

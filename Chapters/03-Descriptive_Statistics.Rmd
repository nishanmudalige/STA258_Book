...
```{r ch3-new-q1-dot, echo=FALSE, fig.height=2.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
...
```{r ch3-new-q2-hist, echo=FALSE, fig.height=3.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
set.seed(21)
...
```{r ch3-new-q3-box, echo=FALSE, fig.height=3.8, fig.width=4.5, fig.align='center', message=FALSE, warning=FALSE}
...
```{r ch3-new-q4-dot, echo=FALSE, fig.height=2.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
...
```{r ch3-new-q5-hist, echo=FALSE, fig.height=4.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
set.seed(23)
...
<div class="webr-exercise-header">Interactive R — Study Hours</div>
<textarea class="webr-editor" rows="9">x <- c(2, 3, 3, 4, 4, 5, 5, 5, 6, 8)
...
**(e)** Here $\bar{x} = \text{Median} = 4.5$. When the mean and median are equal (or very close), the distribution is fairly balanced with no strong skew in either direction.
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Sample Variance & Standard Deviation</div>
<textarea class="webr-editor" rows="8">x <- c(2, 4, 4, 6, 6, 8)
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Comparing Two Groups</div>
<textarea class="webr-editor" rows="10">groupA <- c(14, 15, 14, 16, 15, 14, 16, 15, 15, 16)
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — IQR and Outlier Detection</div>
<textarea class="webr-editor" rows="12">x <- c(3, 4, 5, 5, 6, 7, 8, 9, 10, 12, 13, 30)
...
#    3.00    5.25    7.50   10.58   11.25   30.00

# IQR and outlier cutoffs
IQR(x)                    # [1] 6
5.25 - 1.5 * IQR(x)       # lower cutoff: -3.75
11.25 + 1.5 * IQR(x)      # upper cutoff: 20.25
...
R's `summary()` gives $Q_1 = 5.25$ and $Q_3 = 11.25$ (slightly different from the textbook split-halves values of 5 and 11), but both methods give IQR $= 6$ and both flag **30 as an outlier**. The boxplot shows 30 as an isolated dot above the upper whisker.
</div>
</details>
...
*Recall: a **bar chart** displays counts or frequencies for the categories of a qualitative (categorical) variable — bar width has no numerical meaning. A **histogram** displays the distribution of a quantitative variable by grouping values into intervals.*
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Mean</div>
<textarea class="webr-editor" rows="9">coffee <- c(2, 3, 1, 5, 4, 3, 6, 2, 4, 5)
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Median</div>
<textarea class="webr-editor" rows="10">coffee     <- c(2, 3, 1, 5, 4, 3, 6, 2, 4, 5)
coffee_new <- c(20, 3, 1, 5, 4, 3, 6, 2, 4, 5)
...
# (c) Compare mean and median — before and after the outlier
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Summary Statistics and IQR</div>
<textarea class="webr-editor" rows="11">coffee <- c(2, 3, 1, 5, 4, 3, 6, 2, 4, 5)
...
# (c) Is 20 an outlier? Compare to the upper cutoff
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Variance and Standard Deviation</div>
<textarea class="webr-editor" rows="11">group_a <- c(78, 79, 80, 80, 81, 82, 80)
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Histogram and Boxplot</div>
<textarea class="webr-editor" rows="10">score <- c(40, 61, 65, 68, 70, 72, 74, 75,

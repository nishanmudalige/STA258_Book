...
*Questions 1–5 cover **Section 3.1** (Representing Data); Questions 6–10 cover **Section 3.2** (Numerical Measures); Questions 11–15 cover **Section 3.3** (Graphical Techniques).*
...
The stem-and-leaf plot below displays the scores (out of 60) of 15 students on a statistics quiz. The stem represents the tens digit and each leaf represents the units digit.
...
(a) (1 mark) How many students scored **at least 40**?
(b) (2 marks) Find the **median** score.
(c) (1 mark) Identify the **mode(s)**.
(d) (1 mark) What is the **range** of the scores?
</div>

<details data-type="hint">
<summary>💡 Hint</summary>
<div class="content">
- Read each value as: stem × 10 + leaf. For example, stem 3, leaf 4 → score of 34.
- For the **median** of 15 values, find the 8th value in order (since $\frac{15+1}{2} = 8$).
</div>
</details>
...
<summary>✅ Answer</summary>
<div class="content">
**All scores (sorted):** 23, 27, 28, 31, 34, 34, 36, 39, **40**, 42, 45, 45, 48, 51, 53

**(a)** Scores ≥ 40: 40, 42, 45, 45, 48, 51, 53 → **7 students**.

**(b)** Median = 8th value = **39**.

**(c)** Modes: **34** and **45** (each appears twice).

**(d)** Range = $53 - 23 = \mathbf{30}$.
</div>
</details>
...
The table below shows the ages of participants in a study. The data have been organized into a grouped frequency distribution.
...
(a) (1 mark) What is the **class width** for each age group?
(b) (2 marks) Calculate the **class midpoints** for each group.
(c) (2 marks) Using the midpoints, estimate the **mean** age of participants.
</div>

<details data-type="hint">
<summary>💡 Hint</summary>
<div class="content">
- **Class width** = upper boundary − lower boundary + 1 (for integer data).
- **Midpoint** = (lower limit + upper limit) ÷ 2.
- Estimated mean from grouped data: $\bar{x} \approx \dfrac{\sum f_i \cdot m_i}{\sum f_i}$, where $m_i$ is the midpoint of group $i$.
</div>
</details>
...
<summary>✅ Answer</summary>
<div class="content">
**(a)** Class width = $22 - 18 + 1 = \mathbf{5}$ years.

**(b)**

| Age Group | Midpoint $m_i$ |
|-----------|--------------|
| 18 – 22 | 20 |
| 23 – 27 | 25 |
| 28 – 32 | 30 |
...
**(c)**
$$\bar{x} \approx \frac{14(20) + 20(25) + 11(30) + 8(35) + 7(40)}{14+20+11+8+7} = \frac{280+500+330+280+280}{60} = \frac{1670}{60} \approx \mathbf{27.8 \text{ years}}$$
</div>
</details>
...
```{r ch3-q6-dot, echo=FALSE, fig.height=2.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
coffee <- c(0, 1, 2, 1, 3, 2, 0, 2, 4, 2, 1)
df_q6 <- data.frame(cups = coffee)
ggplot(df_q6, aes(x = cups)) +
  geom_dotplot(binwidth = 0.35, fill = "#e67e22", color = "white", dotsize = 1.0) +
...
(d) (2 marks) If the value of 4 is changed to 12, which measure — mean or median — changes more? What does this tell you about the effect of **outliers** on these measures?
</div>

<details data-type="hint">
<summary>💡 Hint</summary>
<div class="content">
- Sort the 11 values first. For $n = 11$ (odd), median is the $\frac{11+1}{2} = 6$th value.
...
<summary>✅ Answer</summary>
<div class="content">
**Sorted data:** $0, 0, 1, 1, 1, 2, 2, 2, 2, 3, 4$

**(a)** **Right-skewed** — most students drink 0–2 cups with one student at 4, pulling the tail to the right.

**(b)**
$$\bar{x} = \frac{0+0+1+1+1+2+2+2+2+3+4}{11} = \frac{18}{11} \approx 1.64 \text{ cups}$$
Median = 6th value = **2 cups**

**(c)** Mode = **2** (appears 4 times, the tallest stack)

**(d)** Replacing 4 with 12: new $\bar{x} = \frac{26}{11} \approx 2.36$ (increased by ~0.73); median remains **2**. The **mean is sensitive to outliers**; the median is **robust**.
</div>
</details>
...
A dataset of 8 exam scores is given:

$$62,\ 71,\ 68,\ 74,\ 70,\ 65,\ 72,\ 98$$

(a) (2 marks) Calculate the **mean** and **median** of these scores.
(b) (2 marks) Remove the score of 98 and recalculate the **mean** and **median**. How much did each change?
(c) (1 mark) Based on your answers, which measure better represents the **typical** exam score in this dataset? Explain.
</div>

<details data-type="hint">
<summary>💡 Hint</summary>
<div class="content">
- A score that is far from all other values is an **outlier**. Check which measure changes more when the outlier is removed.
</div>
</details>
...
<summary>✅ Answer</summary>
<div class="content">
**Sorted (all 8):** 62, 65, 68, 70, 71, 72, 74, 98

**(a)** $\bar{x} = 580/8 = 72.5$; median = avg of 4th and 5th = $(70+71)/2 = 70.5$

**(b)** Without 98 — sorted: 62, 65, 68, 70, 71, 72, 74

$\bar{x} = 482/7 \approx 68.9$ (decreased by 3.6); median = 4th value = 70 (decreased by only 0.5)

**(c)** The **median** (70 or 70.5) better represents the typical score — it is barely affected by the outlier of 98, while the mean is pulled noticeably upward.
</div>
</details>
...
- Group B: $\bar{x} = 150/10 = 15$, $s \approx 4.22$

Group B's standard deviation is much larger, confirming the visual observation.

**(c)** The mean alone is **insufficient** to describe a dataset — two datasets can have the same mean but very different spreads. The standard deviation (or other measures of variability) is needed to get a complete picture.
</div>
</details>
...
```{r ch3-q11-hist, echo=FALSE, fig.height=3.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
set.seed(11)
...
```{r ch3-q12-box, echo=FALSE, fig.height=3.5, fig.width=4, fig.align='center', message=FALSE, warning=FALSE}
set.seed(12)
...
```{r ch3-q13-box, echo=FALSE, fig.height=3.5, fig.width=5.5, fig.align='center', message=FALSE, warning=FALSE}
set.seed(13)
...
```{r ch3-q14-box, echo=FALSE, fig.height=3.2, fig.width=5, fig.align='center', message=FALSE, warning=FALSE}
set.seed(258)
n14 <- 80
...
```{r ch3-q14-hist, echo=FALSE, fig.height=3.8, fig.width=5.5, fig.align='center', message=FALSE, warning=FALSE}
...
```{r ch3-q15-hist, echo=FALSE, fig.height=3.5, fig.width=6, fig.align='center', message=FALSE, warning=FALSE}
set.seed(15)

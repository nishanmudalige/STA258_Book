...
In other words, if you repeatedly draw samples of size \(n\) and compute the statistic (e.g.\ the sample mean \(\bar X\)), then the values of \(\bar X\) across those samples form a distribution—its sampling distribution.  

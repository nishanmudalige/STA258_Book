...
scale_color_manual(values = rep(c(
  "#F8766D", "#00BA38", "#619CFF", "#F564E3", "#00BFC4", "#B79F00", "#FF61C3"
), length.out = 50))
...
```{r fig.cap="The central area under the standard normal curve with confidence level \\(C\\)", echo=FALSE, fig.align='center', warning=FALSE, message=FALSE}
library(ggplot2)
library(dplyr)
...
- As the degrees of freedom increase, the *t* density curve approaches
  ...
  large.
:::
```{r fig.cap="Comparison of the standard normal distribution and t-distributions with 2 and 9 degrees of freedom", echo=FALSE, fig.align='center', warning=FALSE, message=FALSE}
library(ggplot2)
library(dplyr)

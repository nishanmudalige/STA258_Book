...
<div class="webr-exercise-header">Interactive R — Z Critical Value</div>
<textarea class="webr-editor" rows="4"># 92% two-sided: upper tail probability = ___
qnorm(___)
</textarea>
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Z Confidence Interval Lower Bound</div>
<textarea class="webr-editor" rows="12">df <- read.csv("Academic_Performance_A.csv")
x <- df$Exam_Score
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — t Critical Value</div>
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — t Confidence Interval Lower Bound</div>
<textarea class="webr-editor" rows="12">df <- read.csv("Academic_Performance_A.csv")
x <- df$Final_Exam_Score
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Proportion CI Lower Bound</div>
<textarea class="webr-editor" rows="11">df <- read.csv("Academic_Performance_A.csv")
x <- df$Admitted
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Two-Sample t CI (Unequal Variances)</div>
<textarea class="webr-editor" rows="10">yield_df <- read.csv("plant_yield.csv")
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Ratio of Variances CI</div>
<textarea class="webr-editor" rows="10">brake_df <- read.csv("braking_dist.csv")
...
<div class="webr-exercise">
<div class="webr-exercise-header">Interactive R — Paired t Confidence Interval</div>
<textarea class="webr-editor" rows="9">A <- c(___)
B <- c(___)

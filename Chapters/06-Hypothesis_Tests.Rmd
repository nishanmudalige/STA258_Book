...
The Reference distribution is the standard normal ($Z$) distribution.
...
In terms of a variable $\chi^2_{n-1}$ which follows the $t$-distribution at $n-1$ degrees of freedom, the
p-value for a test of $H_0$ against:

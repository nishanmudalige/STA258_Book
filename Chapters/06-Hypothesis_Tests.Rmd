...
p1 <- ggplot() +
  ...
  geom_area(aes(x = p_x, y = p_y), fill = "#87CEEB", alpha = 0.6) +
...
p1 <- ggplot() +
  ...
  geom_area(aes(x = p_x, y = p_y), fill = "#FFC0CB", alpha = 0.6) +
  geom_hline(yintercept = 0, color = "#000000", linewidth = 1) +
...
p <- ggplot() +
  geom_line(aes(x, y), color = "#000000", linewidth = 1.2) +
  geom_area(aes(x = p_x_left, y = p_y_left), fill = "#90EE90", alpha = 0.6) +
  geom_area(aes(x = p_x_right, y = p_y_right), fill = "#90EE90", alpha = 0.6) +
  geom_hline(yintercept = 0, color = "#000000", linewidth = 1) +
...
p <- ggplot() +
  ...
  geom_area(aes(x = p_x, y = p_y), fill = "#DA70D6", alpha = 0.65) +

...
```{r fig.slr, fig.cap="An illustration of simple linear regression. The blue points are measures of height monthly, and the red line is our SLR model. In this case $m$ is the slope, $b$ is the intercept.", echo=FALSE, message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r, echo=FALSE, out.width='90%', fig.cap= "A simple linear regression illustration with residuals shown. Blue points are observed data, red line is the model, dashed line is the average of $y$, and black lines represent residuals $y_i - \\hat{y}_i$. "}
library(ggplot2)

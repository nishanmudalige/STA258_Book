...
\noindent Given a sample of $n$ observations, the least‑squares estimates of the coefficients $\beta_0,\dots,\beta_p$ are those values $\hat\beta_0,\dots,\hat\beta_p$ which minimize the residual sum of squares,
\[
    \mathrm{RSS}(\beta_0,\dots,\beta_p)
    \;=\;
